...
use Model\Propel\Products;
use Model\Propel\ProductsQuery;
...
class ProductsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Propel.Map.ProductsTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Propel\\Products';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Propel.Products';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Propel\\Products');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Propel\Products) { // it's a model object
