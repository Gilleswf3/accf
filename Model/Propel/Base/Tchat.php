...
/**
 * Base class that represents a row from the 'tchat' table.
 *
 *
 *
 * @package    propel.generator.Model.Propel.Base
 */
abstract class Tchat implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Propel\\Map\\TchatTableMap';
    ...
    /**
     * The value for the id_tchat field.
     *
     * @var        int
     */
    protected $id_tchat;
    ...
    /**
     * Initializes internal state of Model\Propel\Base\Tchat object.
     */
    ...
    /**
     * Compares this with another <code>Tchat</code> instance.  If
     * <code>obj</code> is an instance of <code>Tchat</code>, delegates to
     * <code>equals(Tchat)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tchat The current object, for fluid interface
     */
    ...
    /**
     * Set the value of [id_tchat] column.
     *
     * @param int $v new value
     * @return $this|\Model\Propel\Tchat The current object (for fluent API support)
     */
    public function setIdTchat($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->id_tchat !== $v) {
            $this->id_tchat = $v;
            $this->modifiedColumns[TchatTableMap::COL_ID_TCHAT] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[TchatTableMap::COL_MESSAGE] = true;
        }
    ...
    public function setIdCustomer($v)
    {
        ...
        if ($this->id_customer !== $v) {
            $this->id_customer = $v;
            $this->modifiedColumns[TchatTableMap::COL_ID_CUSTOMER] = true;
        }
    ...
    public function setIdEmployee($v)
    {
        ...
        if ($this->id_employee !== $v) {
            $this->id_employee = $v;
            $this->modifiedColumns[TchatTableMap::COL_ID_EMPLOYEE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TchatTableMap::translateFieldName('IdTchat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_tchat = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TchatTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TchatTableMap::translateFieldName('IdCustomer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_customer = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TchatTableMap::translateFieldName('IdEmployee', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TchatTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Propel\\Tchat'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTchatQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTchatQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TchatTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TchatTableMap::COL_ID_TCHAT] = true;
        if (null !== $this->id_tchat) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TchatTableMap::COL_ID_TCHAT . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TchatTableMap::COL_ID_TCHAT)) {
            $modifiedColumns[':p' . $index++]  = 'id_tchat';
        }
        if ($this->isColumnModified(TchatTableMap::COL_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }
        if ($this->isColumnModified(TchatTableMap::COL_ID_CUSTOMER)) {
            $modifiedColumns[':p' . $index++]  = 'id_customer';
        }
        if ($this->isColumnModified(TchatTableMap::COL_ID_EMPLOYEE)) {
            $modifiedColumns[':p' . $index++]  = 'id_employee';
        }

        $sql = sprintf(
            'INSERT INTO tchat (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_tchat':
                        $stmt->bindValue($identifier, $this->id_tchat, PDO::PARAM_INT);
                        break;
                    case 'message':
    ...
    {
        $pos = TchatTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tchat'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tchat'][$this->hashCode()] = true;
        $keys = TchatTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdTchat(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Propel\Tchat
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Propel\Tchat The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TchatTableMap::COL_ID_TCHAT)) {
            $criteria->add(TchatTableMap::COL_ID_TCHAT, $this->id_tchat);
        }
        if ($this->isColumnModified(TchatTableMap::COL_MESSAGE)) {
            $criteria->add(TchatTableMap::COL_MESSAGE, $this->message);
        }
        if ($this->isColumnModified(TchatTableMap::COL_ID_CUSTOMER)) {
            $criteria->add(TchatTableMap::COL_ID_CUSTOMER, $this->id_customer);
        }
        if ($this->isColumnModified(TchatTableMap::COL_ID_EMPLOYEE)) {
            $criteria->add(TchatTableMap::COL_ID_EMPLOYEE, $this->id_employee);
        }
    ...
    {
        $criteria = ChildTchatQuery::create();
        $criteria->add(TchatTableMap::COL_ID_TCHAT, $this->id_tchat);
    ...
    /**
     * Generic method to set the primary key (id_tchat column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Propel\Tchat (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdTchat(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Propel\Tchat Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEmployees(ConnectionInterface $con = null)
    {
        if ($this->aEmployees === null && ($this->id_employee != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmployees->addTchats($this);
             */
        }
    ...
    public function setCustomers(ChildCustomers $v = null)
    {
        if ($v === null) {
            ...
            $this->setIdCustomer($v->getIdCustomer());
        }
    ...
    {
        if ($this->aCustomers === null && ($this->id_customer != 0)) {
            $this->aCustomers = ChildCustomersQuery::create()->findPk($this->id_customer, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCustomers->addTchats($this);
             */
        }
    ...
    {
        if (null !== $this->aEmployees) {
            $this->aEmployees->removeTchat($this);
        }
        if (null !== $this->aCustomers) {
            $this->aCustomers->removeTchat($this);
        }
        $this->id_tchat = null;
        $this->message = null;
    ...
    {
        return (string) $this->exportTo(TchatTableMap::DEFAULT_STRING_FORMAT);
    }
