 ...
 *
 * @method     ChildCustomersQuery leftJoinTchat($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tchat relation
 * @method     ChildCustomersQuery rightJoinTchat($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tchat relation
 * @method     ChildCustomersQuery innerJoinTchat($relationAlias = null) Adds a INNER JOIN clause to the query using the Tchat relation
 *
 * @method     ChildCustomersQuery joinWithTchat($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tchat relation
 *
 * @method     ChildCustomersQuery leftJoinWithTchat() Adds a LEFT JOIN clause and with to the query using the Tchat relation
 * @method     ChildCustomersQuery rightJoinWithTchat() Adds a RIGHT JOIN clause and with to the query using the Tchat relation
 * @method     ChildCustomersQuery innerJoinWithTchat() Adds a INNER JOIN clause and with to the query using the Tchat relation
 *
 * @method     \Model\Propel\OrdersQuery|\Model\Propel\TchatQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CustomersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Propel\Base\CustomersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Propel\\Customers', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Model\Propel\Tchat object
     *
     * @param \Model\Propel\Tchat|ObjectCollection $tchat the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCustomersQuery The current query, for fluid interface
     */
    public function filterByTchat($tchat, $comparison = null)
    {
        if ($tchat instanceof \Model\Propel\Tchat) {
            return $this
                ->addUsingAlias(CustomersTableMap::COL_ID_CUSTOMER, $tchat->getIdCustomer(), $comparison);
        } elseif ($tchat instanceof ObjectCollection) {
            return $this
                ->useTchatQuery()
                ->filterByPrimaryKeys($tchat->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByTchat() only accepts arguments of type \Model\Propel\Tchat or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Tchat relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildCustomersQuery The current query, for fluid interface
     */
    public function joinTchat($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Tchat');
    ...
    /**
     * Use the Tchat relation Tchat object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Propel\TchatQuery A secondary query class using the current class as primary query
     */
    public function useTchatQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinTchat($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Tchat', '\Model\Propel\TchatQuery');
    }
