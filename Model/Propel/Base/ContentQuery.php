...
use \Exception;
use \PDO;
use Model\Propel\Content as ChildContent;
...
abstract class ContentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Propel\Base\ContentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Model\\Propel\\Content', $modelAlias = null)
    {
