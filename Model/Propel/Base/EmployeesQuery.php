 ...
 *
 * @method     ChildEmployeesQuery leftJoinTchat($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tchat relation
 * @method     ChildEmployeesQuery rightJoinTchat($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tchat relation
 * @method     ChildEmployeesQuery innerJoinTchat($relationAlias = null) Adds a INNER JOIN clause to the query using the Tchat relation
 *
 * @method     ChildEmployeesQuery joinWithTchat($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tchat relation
 *
 * @method     ChildEmployeesQuery leftJoinWithTchat() Adds a LEFT JOIN clause and with to the query using the Tchat relation
 * @method     ChildEmployeesQuery rightJoinWithTchat() Adds a RIGHT JOIN clause and with to the query using the Tchat relation
 * @method     ChildEmployeesQuery innerJoinWithTchat() Adds a INNER JOIN clause and with to the query using the Tchat relation
 *
 * @method     \Model\Propel\AgenciesQuery|\Model\Propel\StandardsQuery|\Model\Propel\TchatQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EmployeesQuery extends ModelCriteria
{
    ...
    public function filterByTchat($tchat, $comparison = null)
    {
        if ($tchat instanceof \Model\Propel\Tchat) {
            return $this
                ->addUsingAlias(EmployeesTableMap::COL_ID_EMPLOYEE, $tchat->getIdEmployee(), $comparison);
