...
/**
 * Base class that represents a row from the 'agencies' table.
 *
 *
 *
 * @package    propel.generator.Model.Propel.Base
 */
abstract class Agencies implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Propel\\Map\\AgenciesTableMap';
    ...
    /**
     * Initializes internal state of Model\Propel\Base\Agencies object.
     */
    ...
    /**
     * Compares this with another <code>Agencies</code> instance.  If
     * <code>obj</code> is an instance of <code>Agencies</code>, delegates to
     * <code>equals(Agencies)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Agencies The current object, for fluid interface
     */
    ...
    public function setIdAgency($v)
    {
        ...
        if ($this->id_agency !== $v) {
            $this->id_agency = $v;
            $this->modifiedColumns[AgenciesTableMap::COL_ID_AGENCY] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[AgenciesTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[AgenciesTableMap::COL_ZIPCODE] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[AgenciesTableMap::COL_CITY] = true;
        }
    ...
    public function setArea($v)
    {
        ...
        if ($this->area !== $v) {
            $this->area = $v;
            $this->modifiedColumns[AgenciesTableMap::COL_AREA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AgenciesTableMap::translateFieldName('IdAgency', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_agency = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AgenciesTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AgenciesTableMap::translateFieldName('Zipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AgenciesTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = AgenciesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Propel\\Agencies'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAgenciesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Agencies::setDeleted()
     * @see Agencies::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAgenciesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AgenciesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->employeessScheduledForDeletion !== null) {
                if (!$this->employeessScheduledForDeletion->isEmpty()) {
                    \Model\Propel\EmployeesQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AgenciesTableMap::COL_ID_AGENCY)) {
            $modifiedColumns[':p' . $index++]  = 'id_agency';
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_ZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = 'zipcode';
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'city';
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_AREA)) {
            $modifiedColumns[':p' . $index++]  = 'area';
        }

        $sql = sprintf(
            'INSERT INTO agencies (%s) VALUES (%s)',
    ...
    {
        $pos = AgenciesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Agencies'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Agencies'][$this->hashCode()] = true;
        $keys = AgenciesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdAgency(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Propel\Agencies
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Propel\Agencies The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AgenciesTableMap::COL_ID_AGENCY)) {
            $criteria->add(AgenciesTableMap::COL_ID_AGENCY, $this->id_agency);
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_ADDRESS)) {
            $criteria->add(AgenciesTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_ZIPCODE)) {
            $criteria->add(AgenciesTableMap::COL_ZIPCODE, $this->zipcode);
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_CITY)) {
            $criteria->add(AgenciesTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(AgenciesTableMap::COL_AREA)) {
            $criteria->add(AgenciesTableMap::COL_AREA, $this->area);
        }
    ...
    {
        $criteria = ChildAgenciesQuery::create();
        $criteria->add(AgenciesTableMap::COL_ID_AGENCY, $this->id_agency);
    ...
    /**
     * Generic method to set the primary key (id_agency column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Propel\Agencies (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdAgency(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Propel\Agencies Clone of current object.
     * @throws PropelException
     */
    ...
    public function initEmployeess($overrideExisting = true)
    {
        ...
        $this->collEmployeess->setModel('\Model\Propel\Employees');
    }
     ...
     * If this ChildAgencies is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAgencies The current object (for fluent API support)
     */
    public function setEmployeess(Collection $employeess, ConnectionInterface $con = null)
    {
        ...
        foreach ($employeessToDelete as $employeesRemoved) {
            $employeesRemoved->setAgencies(null);
        }
    ...
    {
        return (string) $this->exportTo(AgenciesTableMap::DEFAULT_STRING_FORMAT);
    }
