...
use \Agencies as ChildAgencies;
use \AgenciesQuery as ChildAgenciesQuery;
use \Employees as ChildEmployees;
use \EmployeesQuery as ChildEmployeesQuery;
use \Exception;
use \PDO;
use Map\AgenciesTableMap;
...
abstract class Agencies implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AgenciesTableMap';
    ...
    /**
     * Initializes internal state of Base\Agencies object.
     */
     ...
     * @return $this|\Agencies The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Agencies'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Agencies (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Agencies Clone of current object.
     * @throws PropelException
     */
