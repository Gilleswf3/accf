...
abstract class Employees implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EmployeesTableMap';
    ...
    /**
     * Initializes internal state of Base\Employees object.
     */
     ...
     * @return $this|\Employees The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Employees'), 0, $e);
        }
    }
    ...
    public function initHotlines($overrideExisting = true)
    {
        ...
        $this->collHotlines->setModel('\Hotline');
    }
    ...
    public function initStandardss($overrideExisting = true)
    {
        ...
        $this->collStandardss->setModel('\Standards');
    }
