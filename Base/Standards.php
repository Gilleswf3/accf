...
abstract class Standards implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\StandardsTableMap';
    ...
    /**
     * Initializes internal state of Base\Standards object.
     */
     ...
     * @return $this|\Standards The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Standards'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Standards (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Standards Clone of current object.
     * @throws PropelException
     */
