 ...
 *
 * @method     \AgenciesQuery|\HotlineQuery|\StandardsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EmployeesQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \Agencies object
     *
     * @param \Agencies|ObjectCollection $agencies The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($agencies instanceof \Agencies) {
            return $this
            ...
            throw new PropelException('filterByAgencies() only accepts arguments of type \Agencies or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \AgenciesQuery A secondary query class using the current class as primary query
     */
    public function useAgenciesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAgencies($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Agencies', '\AgenciesQuery');
    }
    ...
    /**
     * Filter the query by a related \Standards object
     *
     * @param \Standards|ObjectCollection $standards the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEmployeesQuery The current query, for fluid interface
     */
    ...
    {
        if ($standards instanceof \Standards) {
            return $this
            ...
            throw new PropelException('filterByStandards() only accepts arguments of type \Standards or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \StandardsQuery A secondary query class using the current class as primary query
     */
    public function useStandardsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinStandards($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Standards', '\StandardsQuery');
    }
