...
use \HotlineQuery as ChildHotlineQuery;
use \Exception;
use \PDO;
use Map\HotlineTableMap;
...
abstract class Hotline implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\HotlineTableMap';
    ...
    /**
     * Initializes internal state of Base\Hotline object.
     */
     ...
     * @return $this|\Hotline The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Hotline'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Hotline (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Hotline Clone of current object.
     * @throws PropelException
     */
