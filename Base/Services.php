...
abstract class Services implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ServicesTableMap';
    ...
    /**
     * Initializes internal state of Base\Services object.
     */
     ...
     * @return $this|\Services The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Services'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Services (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Services Clone of current object.
     * @throws PropelException
     */
