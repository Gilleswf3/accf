...
abstract class Content implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ContentTableMap';
    ...
    /**
     * Initializes internal state of Base\Content object.
     */
     ...
     * @return $this|\Content The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Content'), 0, $e);
        }
    }
