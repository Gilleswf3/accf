...
require_once 'controllers/front_private/products_controller.php';
...
require_once 'controllers/chat_customer_controller.php';
require_once 'controllers/chat_insert_controller.php';
